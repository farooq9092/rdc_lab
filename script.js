...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const testDatabase = [
        ...
        { name: "Blood Sugar Fasting (BSF)", price: "300", time: "Same Day" },
        { name: "Blood Sugar Random (BSR)", price: "300", time: "Same Day" },
        { name: "Lipid Profile", price: "2000", time: "Same Day" },
        { name: "Liver Function Tests (LFTs)", price: "1400", time: "Same Day" },
        { name: "Renal Function Tests (RFTs)", price: "1200", time: "Same Day" },
        { name: "Thyroid Profile (T3, T4, TSH)", price: "4000", time: "Same Day" },
        { name: "Vitamin D3", price: "3500", time: "24 Hours" },
        { name: "HbA1c", price: "1800", time: "Same Day" },
        { name: "Uric Acid", price: "500", time: "Same Day" },
        { name: "Urine Routine Examination", price: "300", time: "Same Day" },
        { name: "Serum Calcium", price: "1000", time: "Same Day" },
        { name: "Hepatitis B Surface Antigen (HBsAg)", price: "3000", time: "Same Day" },
        { name: "Anti HCV", price: "500", time: "Same Day" },
        { name: "C-Reactive Protein (CRP)", price: "1800", time: "Same Day" },
        { name: "Dengue NS1 Antigen", price: "1500", time: "Same Day" },
        { name: "Malaria Parasite (MP)", price: "600", time: "Same Day" },
        { name: "Serum Electrolytes", price: "1200", time: "Same Day" },
        { name: "25-Hydroxy Vitamin-D", price: "3500", time: "24 Hours" },
        { name: "75g Glucose Tolarance  test  (GTT)", price: "1200", time: "Same Day" },
        { name: "Albumin (Serum)", price: "600", time: "Same Day" },
        { name: "Alkaline Phosphatase (ALP)", price: "600", time: "Same Day" },
        { name: "Alpha Fetoprotein (AFP)", price: "3500", time: "Same Day" },
        ...
        { name: "Anti Cyclic Citrullinated Peptide", price: "3500", time: "24 Hours" },
        ...
        { name: "Anti HIV 1&2 ELISA", price: "2500", time: "Same Day" },
        { name: "Anti Nuclear Antibodies (ANA profile )", price: "7500", time: "24 Hours" },
        { name: "Anti Tissue Transglutaminase lgA", price: "2500", time: "24 Hours" },
        { name: "Anti Tissue Transglutaminase lgG", price: "2500", time: "24 Hours" },
        { name: "Beta HCG", price: "2200", time: "Same Day" },
        { name: "Bicarbonate (HCO3)", price: "600", time: "Same Day" },
        { name: "Bilirubin Direct", price: "800", time: "Same Day" },
        { name: "Bilirubin (Direct/Indirect)", price: "1200", time: "Same Day" },
        { name: "Bilirubin Indirect", price: "800", time: "Same Day" },
        { name: "BIOPSY LARGE", price: "8000", time: "3 Days" },
        { name: "BIOPSY MEDIUM FOR HP", price: "5000", time: "3 Days" },
        { name: "Blood Culture", price: "4000", time: "3 Days" },
        ...
        { name: "Blood Glucose (sugar) Random", price: "300", time: "Same Day" },
        { name: "Blood Group & RH Factor", price: "300", time: "Same Day" },
        { name: "Blood Urea Nitrogen (BUN)", price: "600", time: "Same Day" },
        { name: "Breast Milk for C/S", price: "2500", time: "Same Day" },
        { name: "Brucella Antibody", price: "2500", time: "Same Day" },
        { name: "C3 & C4 Level", price: "4500", time: "24 Hours" },
        { name: "CA-125", price: "4000", time: "24 Hours" },
        { name: "CA 15-3", price: "4500", time: "24 Hours" },
        { name: "Calcium Serum", price: "1000", time: "Same Day" },
        { name: "Carcinoembryonic Antigen CEA", price: "4500", time: "24 Hours" },
        { name: "CBC FOR DENGUE", price: "90", time: "Same Day" },
        { name: "CBC with PERIPHERAL FILM (MP)", price: "2000", time: "Same Day" },
        { name: "Ceruloplasmin Serum", price: "4000", time: "24 Hours" },
        { name: "Chloride (Serum)", price: "600", time: "Same Day" },
        { name: "Cholesterol", price: "600", time: "Same Day" },
        { name: "CK-MB", price: "1200", time: "Same Day" },
        { name: "Clotting Time", price: "300", time: "Same Day" },
        { name: "Coombs Direct", price: "1200", time: "Same Day" },
       ...
       { name: "C-Peptide Level", price: "5000", time: "24 Hours" },
        ...
        { name: "D-Dimer Test", price: "2500", time: "Same Day" },
        { name: "DHEA SO4", price: "3500", time: "24 Hours" },
        { name: "Dengue IgG IgM", price: "800", time: "Same Day" },
        { name: "DRUG PROFILE", price: "10000", time: "24 Hours" },
        { name: "Electrolytes (Na, Cl)", price: "1200", time: "Same Day" },
        { name: "ENA PROFILE", price: "8500", time: "24 Hours" },
        { name: "ESR", price: "300", time: "Same Day" },
        { name: "Estradiol / Serum (E2)", price: "2800", time: "24 Hours" },
        { name: "Ferritin Level", price: "2200", time: "24 Hours" },
        { name: "DOPPLER ULTRASOUND", price: "3000", time: "Same Day" },
        { name: "Fluid Complete Examination ()", price: "2000", time: "Same Day" },
        { name: "FNAC (FINE NEEDLE ASPIRATION)", price: "4000", time: "Same Day" },
        { name: "Folate Level (Folic Acid)", price: "3500", time: "24 Hours" },
        { name: "[Free] (FT3, FT4, TSH) THYROID", price: "4500", time: "24 Hours" },
        { name: "Free T-3 (Free Tri-iodothyron)", price: "1800", time: "24 Hours" },
        { name: "Free T-4 (Free Thyroxine)", price: "1800", time: "24 Hours" },
        { name: "FSH", price: "2200", time: "24 Hours" },
        { name: "GCT", price: "600", time: "Same Day" },
        { name: "Growth Hormone (GH)", price: "2800", time: "24 Hours" },
        { name: "HAV lgM", price: "3000", time: "Same Day" },
        { name: "HbA1C (Glycosylated Hemoglob)", price: "1800", time: "Same Day" },
        { name: "Hb Electrophoresis", price: "3300", time: "24 Hours" },
        { name: "Hb (Hemoglobin)", price: "300", time: "Same Day" },
        { name: "HBsAb (Hepatitis B Surface Anti)", price: "3000", time: "Same Day" },
        { name: "HCV RNA PCR Quantitative", price: "6000", time: "3 Days" },
        { name: "HEV lgM", price: "3000", time: "Same Day" },
        { name: "HEV lgG", price: "3000", time: "Same Day" },
        { name: "Helicobacter Pylori lgM", price: "2500", time: "Same Day" },
        { name: "Helicobacter Pylori lgG", price: "2500", time: "Same Day" },
        ...
        { name: "HIV SCREENING ICT", price: "600", time: "Same Day" },
        { name: "Homocysteine Level", price: "3600", time: "24 Hours" },
        { name: "HVS Culture", price: "2500", time: "3 Days" },
        { name: "IgE", price: "2200", time: "24 Hours" },
        { name: "IMMUNOGLOBULIN IGM/IGG/IGA", price: "5000", time: "24 Hours" },
        { name: "Total IRON BINDING CAPACITY", price: "1800", time: "Same Day" },
        { name: "Lipase", price: "1400", time: "Same Day" },
        { name: "Lipid Profile", price: "2000", time: "Same Day" },
        { name: "Magnesium Serum", price: "1000", time: "Same Day" },
        { name: "Malaria Parasite (ICT) MP", price: "600", time: "Same Day" },
        { name: "Malaria Parasite MP Slide", price: "800", time: "Same Day" },
        { name: "Phosphorus Serum", price: "600", time: "Same Day" },
        { name: "Platelet Count", price: "300", time: "Same Day" },
        { name: "PLEURAL FLUID R/E", price: "2000", time: "Same Day" },
        { name: "Potassium (Serum)", price: "600", time: "Same Day" },
        { name: "Pregnancy Test", price: "600", time: "Same Day" },
        { name: "Prolactin Serum", price: "2200", time: "24 Hours" },
        { name: "Prostate Specific Antigen (PSA)", price: "2800", time: "24 Hours" },
        { name: "PROTEIN ELECTROPHORESIS", price: "3500", time: "3 Days" },
        { name: "PT with INR (Prothrombin Time)", price: "700", time: "Same Day" },
        { name: "Pus Culture", price: "2500", time: "3 Days" },
        { name: "QuantiFERON TB (IGRA) GOLD", price: "10000", time: "3 Days" },
        { name: "RA Factor (Qualitative)", price: "1000", time: "Same Day" },
        { name: "Rubella IgG/IgM", price: "2500", time: "Same Day" },
        { name: "Semen Analysis", price: "1000", time: "Same Day" },
        { name: "Semen CS ", price: "2500", time: "3 Days" },
        { name: "SERUM ANA", price: "1500", time: "24 Hours" },
        ...
        { name: "SPUTUM FOR AFB", price: "1000", time: "3 Days" },
        { name: "Stone Analysis", price: "2500", time: "3 Days" },
        { name: "Stool Complete Examination", price: "700", time: "Same Day" },
        { name: "Stool Culture", price: "2500", time: "3 Days" },
        { name: "Stool for H.Pylori Antigen", price: "2500", time: "Same Day" },
        ...
        { name: "Testosterone", price: "2200", time: "24 Hours" },
        { name: "Thyroid Function Test (TFT) ", price: "4000", time: "24 Hours" },
        { name: "Total Bilirubin", price: "500", time: "Same Day" },
        { name: "TPHA", price: "3000", time: "24 Hours" },
        { name: "Triglycerides TG (Serum)", price: "600", time: "Same Day" },
        { name: "Trop-I", price: "2500", time: "Same Day" },
